...
class CreatePouffesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pouffes', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
        ...
        Schema::table('pouffes', function (Blueprint $table) {
    ...
    {
        Schema::table('pouffes', function (Blueprint $table) {
            $table->dropForeign('pouffes_user_id_foreign');
        });
